...
df_interest_gene_knn.to_csv('InterestGeneForCompoundsKNN.csv')
df_difference.to_csv('ProbabilityDifferencebetweenPredandTureKNN.csv')
df_threshold.to_csv('ThresholdKNN.csv')