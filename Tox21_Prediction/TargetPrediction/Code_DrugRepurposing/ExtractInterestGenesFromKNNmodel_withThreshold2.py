...
df_pred = pd.DataFrame(y_pro_array_knn)
df_pred = df_pred.T
...
df_interest_gene_knn = df_interest_targets[df_interest_targets['interest_gene_targets'].astype(str) != '[]']
print(df_interest_gene_knn.head(5))

df_interest_gene_knn.to_csv('InterestGeneForCompoundsKNN2.csv')
df_difference.to_csv('ProbabilityDifferencebetweenPredandTureKNN2.csv')
df_threshold.to_csv('ThresholdKNN2.csv')