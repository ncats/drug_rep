...
df_interest_gene_rf.to_csv('InterestGeneForCompoundsRF.csv')
df_difference.to_csv('ProbabilityDifferencebetweenPredandTureRF.csv')
df_threshold.to_csv('ThresholdRF.csv')
...
df_interest_gene_xgb.to_csv('InterestGeneForCompoundsXGB.csv')
df_difference.to_csv('ProbabilityDifferencebetweenPredandTureXGB.csv')
df_threshold.to_csv('ThresholdXGB.csv')