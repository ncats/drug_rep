...
for k in range(N):
    ...
    clf = KNeighborsClassifier(n_neighbors=31,p=3).fit(x_train, y_train)
...
df_interest_gene_knn.to_csv('InterestGeneForCompoundsKNN3.csv')
df_difference.to_csv('ProbabilityDifferencebetweenPredandTureKNN3.csv')
df_threshold.to_csv('ThresholdKNN3.csv')