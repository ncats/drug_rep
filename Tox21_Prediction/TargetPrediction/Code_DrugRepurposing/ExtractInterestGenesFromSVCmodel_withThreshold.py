...
df_interest_gene_svc.to_csv('InterestGeneForCompoundsSVC_withThreshold.csv')
df_difference.to_csv('ProbabilityDifferencebetweenPredandTureSVC.csv')
df_threshold.to_csv('ThresholdSVC.csv')